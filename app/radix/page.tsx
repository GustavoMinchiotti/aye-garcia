    ...
    <>
      ...
      <section className="bg-baseOscura p-6 rounded-lg shadow-lg">
        ...
        <div className="space-y-4 max-w-md">
          ...
          <div>
            <label className="block text-sm font-medium text-contraste2 mb-2">
              Select Radix (con estilos MAREVOX)
            </label>
            <SelectCustom
              options={[
          ...
          <div>
            ...
            <select className="w-full px-4 py-2 border-2 border-(--color-contraste-1) rounded-lg bg-(--color-contraste-2) text-(--color-base-oscura) hover:bg-(--color-contraste-3) focus:ring-2 focus:ring-(--color-acento-2) focus:outline-none transition-all duration-200">
              <option className="bg-acento1 text-(--color-base-clara)">
                Opción 1
              </option>
              <option>Opción 2</option>
              <option>Opción 3</option>

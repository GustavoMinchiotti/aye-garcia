        ...
        <div className="flex items-center gap-4">
          ...
          {!email ? (
            <>
              <Link
                href="/login"
                className="px-3 py-1 rounded border border-acento-1"
              >
                Entrar
              </Link>
            </>
            ...
            <div className="flex items-center gap-3">
              <span className="text-sm text-contraste-3 hidden sm:inline">
                {email}
              </span>
              <button
                onClick={handleSignOut}
                className="px-3 py-1 rounded bg-acento-2 text-white"
              >
                Cerrar sesión
              </button>
            </div>
